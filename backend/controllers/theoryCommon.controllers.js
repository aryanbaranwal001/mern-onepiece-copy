...
export const upvote = async (req, res) => {
  try {
    ...
    return res.status(200).json({ message: "Upvoted successfully", theory: updatedTheory });
  } catch (error) {
...
export const downvote = async (req, res) => {
  try {
    ...
    return res.status(200).json({ message: "Downvoted successfully", theory: updatedTheory });
  } catch (error) {
